...
{ 
  ...
  set_component( svit_index++,  SPECTROMETER,  SW_EN7 ,     SW_OFF,          MUX0,       11,      V_THRESHOLD_VALUE, V_UNDER_VALUE,       MUX0,        6 ,    I_THRESHOLD_VALUE,   I_UNDER_VALUE,    MUX_NULL,       0     );
  set_component( svit_index++,  STAR_TRACKER,  SW_EN8 ,     SW_OFF,          MUX0,       23,      V_THRESHOLD_VALUE,  V_UNDER_VALUE,     MUX0,        7 ,    I_THRESHOLD_VALUE, I_UNDER_VALUE,    MUX1    ,       7     );        
  set_component( svit_index++,  FC_5V       ,  SW_EN1 ,     SW_OFF,          MUX1,       19,      V_THRESHOLD_VALUE,   V_UNDER_VALUE,    MUX1,        0 ,    I_THRESHOLD_VALUE, I_UNDER_VALUE,    MUX_NULL,       0     );        
  set_component( svit_index++,  FC_3_3V     ,  SW_EN1 ,     SW_OFF,          MUX2,       13,      V_THRESHOLD_VALUE,    V_UNDER_VALUE,   MUX2,        14,    I_THRESHOLD_VALUE, I_UNDER_VALUE,  MUX_NULL,       0     );        
  set_component( svit_index++,  GPS_1       ,  SW_EN2 ,     SW_OFF,          MUX1,       21,      V_THRESHOLD_VALUE,  V_UNDER_VALUE,    MUX1,        1 ,    I_THRESHOLD_VALUE, I_UNDER_VALUE,   MUX_NULL,       0     );  
  set_component( svit_index++,  GPS_2       ,  SW_EN3 ,     SW_OFF,          MUX1,       26,      V_THRESHOLD_VALUE,   V_UNDER_VALUE,    MUX1,        2 ,    I_THRESHOLD_VALUE, I_UNDER_VALUE,   MUX_NULL,       0     );    
  set_component( svit_index++,  CDH_IB      ,  SW_EN4 ,     SW_OFF,          MUX1,       29,      V_THRESHOLD_VALUE,   V_UNDER_VALUE,    MUX1,        3 ,    I_THRESHOLD_VALUE, I_UNDER_VALUE,   MUX_NULL,       0     );  
  set_component( svit_index++,  HEATER_1    ,  SW_EN5 ,     SW_OFF,          MUX1,       14,      V_THRESHOLD_VALUE,   V_UNDER_VALUE,      MUX1,        31,    I_THRESHOLD_VALUE, I_UNDER_VALUE,   MUX_NULL,       0     ); 
  set_component( svit_index++,  HEATER_2    ,  SW_EN6 ,     SW_OFF,          MUX1,       27,      V_THRESHOLD_VALUE,   V_UNDER_VALUE,      MUX1,        4 ,    I_THRESHOLD_VALUE, I_UNDER_VALUE,   MUX_NULL,       0     );  
  set_component( svit_index++,  CMG         ,  SW_EN9 ,     SW_OFF,          MUX1,       15,      V_THRESHOLD_VALUE,   V_UNDER_VALUE,      MUX1,        8 ,    I_THRESHOLD_VALUE, I_UNDER_VALUE,   MUX_NULL,       0     ); 
  set_component( svit_index++,  SUN_SENSOR  ,  SW_EN10,     SW_OFF,          MUX1,       25,      V_THRESHOLD_VALUE,   V_UNDER_VALUE,      MUX1,        9 ,    I_THRESHOLD_VALUE, I_UNDER_VALUE,   MUX_NULL,       0     );  
  ...
  set_component( svit_index++,  MAESTRO     ,  SW_EN13,     SW_OFF,          MUX1,       22,      V_THRESHOLD_VALUE,   V_UNDER_VALUE,      MUX1,        12,    I_THRESHOLD_VALUE, I_UNDER_VALUE,    MUX2    ,       8     );  
  set_component( svit_index++,  MAGNETOM    ,  SW_EN14,     SW_OFF,          MUX0,       4 ,      V_THRESHOLD_VALUE,   V_UNDER_VALUE,      MUX0,        6 ,    I_THRESHOLD_VALUE, I_UNDER_VALUE,  MUX_NULL,       0     );    
  set_component( svit_index++,  FOG_15V     ,  SW_EN16,     SW_OFF,          MUX2,       21,      V_THRESHOLD_VALUE,   V_UNDER_VALUE,      MUX_NULL,    0,    I_THRESHOLD_VALUE, I_UNDER_VALUE,   MUX_NULL,       0     );  // Fake Data changed mux 2 20 to mux null 0
  set_component( svit_index++,  FOG_5V      ,  SW_EN15,     SW_OFF,          MUX1,       18,      V_THRESHOLD_VALUE,   V_UNDER_VALUE,      MUX1,        13,    I_THRESHOLD_VALUE, I_UNDER_VALUE,   MUX_NULL,       0     );  // Fake Data
