...
#define V_THRESHOLD_VALUE 0xFF
#define V_UNDER_VALUE 0
#define I_THRESHOLD_VALUE 0xFF
#define I_UNDER_VALUE 00
...
// Timers and Counters
volatile uint16_t timer0_counter[2];
volatile uint16_t timer1_counter[2];		//0th elt for rad/torq 30 min delay; 1th elt for CDH IB heartbeat timeout   //CHANGE DEFS
